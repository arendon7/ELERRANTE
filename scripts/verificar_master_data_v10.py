#!/usr/bin/env python3
"""Barrera de integridad para Datos maestros V1.0."""
...
require("const VERSION='1.0.0'" in module,'Motor Datos maestros no declara V1.0.0')
...
require(module.count('writeJSON(STORAGE_KEY,store)')==2,'El módulo debe escribir únicamente el overlay de gobierno')
require('writeJSON(PURCHASES_KEY' not in module,'Datos maestros no puede escribir el historial de compras')
require('DATA.materials=' not in module and '.cost=' not in module,'Datos maestros no puede reescribir materiales/costos maestros')
...
require('./assets/master-data-v10.js' in worker and './assets/master-data-v10.css' in worker,'Service worker no precachea Datos maestros V1.0')
require("endsWith('/assets/master-data-v10.js')" in worker and "endsWith('/assets/master-data-v10.css')" in worker,'Service worker no sirve fresco Datos maestros V1.0')
require('master_data_module=v1.0.0' in deploy,'Metadata de release no declara Datos maestros V1.0')
require('master_data_module=v1.0.0' in pages and '_site/assets/master-data-v10.js' in pages,'Pages no certifica Datos maestros V1.0')
...
print('EL ERRANTE — DATOS MAESTROS V1.0')
print('='*42)
