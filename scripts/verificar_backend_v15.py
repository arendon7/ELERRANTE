...
require(config, 'version: "1.5.0"', "La configuración comercial no declara V1.5.0.")
...
require(worker, 'el-errante-v1-5-0', "Service worker no usa caché V1.5.0.")
...
require(host, 'PUBLIC_VERSION="1.5.0"', "Host mode no declara V1.5.0.")
require(host, 'ACTIVE_CACHE="el-errante-v1-5-0"', "Host mode no apunta a la caché V1.5.0.")
...
require(health, 'el-errante-v1-5-0', "Public Health no verifica la caché V1.5.0.")
