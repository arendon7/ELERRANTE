...
require(config, 'version: "2.1.0"', "La configuración comercial no declara V1.9.0.")
...
require(worker, 'el-errante-v2-2-0', "Service worker no usa caché V1.9.0.")
...
require(host, 'PUBLIC_VERSION="2.2.0"', "Host mode no declara V1.9.0.")
require(host, 'ACTIVE_CACHE="el-errante-v2-2-0"', "Host mode no apunta a la caché V1.9.0.")
...
require(health, 'el-errante-v2-2-0', "Public Health no verifica la caché V1.9.0.")
