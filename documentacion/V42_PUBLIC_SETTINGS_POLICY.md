...
- `ordering`: canales, disponibilidad y configuración pública de pedido/handoff;
...
La migración `schema-v26.sql` sólo debe aplicarse cuando exista una decisión explícita de activar/actualizar el backend correspondiente. Antes de hacerlo se debe verificar:
