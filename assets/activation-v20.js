(()=>{
  ...
  function healthChecklist(health){
    ...
    return [
      checklistItem(health?.schema_version==='2.1','Esquema V2.1','La función de diagnóstico confirma también la transición segura V2.1.'),
      checklistItem(['1.4','1.5','1.6','1.9','2.0','2.1'].every(value=>migrations.includes(value)),'Migraciones completas',`Registradas: ${migrations.join(', ')||'ninguna'}`),
