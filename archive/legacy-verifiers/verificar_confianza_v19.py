...
require("admin.html", "Operación, producción, materiales, medición, compras y despacho · V2.4", "assets/trust-v19.js", "assets/trust-v19.css")
require("assets/commerce-config-v14.js", 'version: "2.4.0"', "deliveryFeePolicy", "expectedResponseHours")
require("assets/host-mode.js", 'PUBLIC_VERSION="2.4.0"', 'ACTIVE_CACHE="el-errante-v2-4-0"')
require("service-worker.js", "el-errante-v2-4-0", "assets/trust-v19.js", "assets/trust-v19.css", "schema-v19.sql")
require("deploy-version.txt", "version=2.4.0", "cache=el-errante-v2-4-0")
