...
const CORE=[
  ...
  './assets/content-v5.js','./assets/content-v17.js','./assets/commerce-ux-v18.js','./assets/trust-v19.js',
  ...
  './assets/admin-v15.js','./assets/commerce-v14.js','./assets/commerce-v14.css','./assets/commerce-v15.css',
  './assets/commerce-v16.css','./assets/commerce-v18.css','./assets/trust-v19.css','./assets/activation-v20.css',
  './assets/daily-ops-v21.css','./assets/production-v22.css','./assets/materials-v23.css','./assets/measurement-v24.css',
  './assets/procurement-v25.css','./assets/finance-v27.css','./assets/operations-v16.js','./assets/control.js','./assets/presentation.js',
  ...
  './backend/supabase/schema-v19.sql','./backend/supabase/schema-v20.sql','./backend/supabase/schema-v21.sql',
  './backend/supabase/schema-v22.sql','./backend/supabase/schema-v23.sql','./backend/supabase/schema-v24.sql',
  './backend/supabase/schema-v25.sql','./documentacion/modelo-oferta-v09.json',
  './documentacion/sesiones/aire-y-tiempo-paquete-comite-v09.json',
  './documentacion/sesiones/AIRE_Y_TIEMPO_PAQUETE_COMITE_V09.md','./offline.html','./deploy-version.txt'
];
...
self.addEventListener('install',event=>{
  event.waitUntil((async()=>{
    ...
    await cacheOptional(cache,[...GENERATED,...COMPATIBILITY]);
  })());
  self.skipWaiting();
});
...
function canonicalRequest(request){
  ...
  return new Request(new URL(resolved,self.registration.scope).toString(),request);
}
...
self.addEventListener('fetch',event=>{
  ...
  const fresh=request.mode==='navigate'||request.destination==='document'||
    url.pathname.endsWith('/deploy-version.txt')||url.pathname.endsWith('/assets/commerce-runtime-config.js')||
    url.pathname.endsWith('/assets/brand-canon-v28.js')||url.pathname.endsWith('/assets/generated/manifest-v28.json')||
    url.pathname.endsWith('/materialized-site-v28.json');
