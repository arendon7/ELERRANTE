...
test.describe('Navegación pública V3 truth + V4',()=>{
  ...
  test('la PWA incluye rutas editoriales y todas las capas V4 activas',async({request})=>{
    ...
    for(const token of [
      ...
      './assets/brand-v4-public.css','./assets/brand-v4-public.js','./assets/brand-v4-product.css','./assets/brand-v4-events.css','./assets/brand-v4-editorial.css','./assets/brand-v4-utility.css'
