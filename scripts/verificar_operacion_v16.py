...
for marker in ["Operación, finanzas y confianza · V1.9", 'id="operations-v16"', "operations-v16.js", "commerce-v16.css"]:
...
if "el-errante-v1-9-0" not in worker:
    ISSUES.append("Service worker no usa caché V1.6")
if 'PUBLIC_VERSION="1.9.0"' not in host or 'ACTIVE_CACHE="el-errante-v1-9-0"' not in host:
