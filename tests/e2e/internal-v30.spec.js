...
async function seedOperational(page){
  await page.addInitScript(()=>{
    localStorage.setItem('ee_v14_orders',JSON.stringify([{id:'EE-V31-001',status:'approved',createdAt:'2026-08-07T10:00:00.000Z',total:60000,delivery:{requestedDate:'2026-08-07',city:'Medellín'},customer:{name:'Prueba V3.1'},items:[{productId:'la-errante',name:'La Errante',quantity:2,unit_cost_snapshot:12000}]}]));
