...
## Summary
- 1996 nodes · 3567 edges · 214 communities (145 shown, 69 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 128 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a6edba45`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- public-config-admin-v42.js
- procurement-v25.js
...
- schema-v14.sql
- admin-legacy-integrity-v424.js
- schema-v15.sql
- service-worker.js
- servidor_demo.py
...
- connected-internal-orders-v423.spec.js
...
- v4-public-channel-settings.spec.js
- verificar_demo.py
- schema-v23.sql
...
- commerce-readiness-v422.spec.js
...
- `load()` --indirect_call--> `group()`  [INFERRED]
  assets/admin-config-promotion-v42.js → tests/e2e/v42-config-promotion.spec.js
- `bind()` --indirect_call--> `group()`  [INFERRED]
  assets/admin-config-promotion-v42.js → tests/e2e/v42-config-promotion.spec.js
...
## Communities (214 total, 69 thin omitted)

### Community 0 - "public-config-admin-v42.js"
Cohesion: 0.06
Nodes (62): authenticate(), createAccount(), derive(), field(), findReviewAccount(), nextTarget(), openSession(), render() (+54 more)

### Community 1 - "procurement-v25.js"
Cohesion: 0.07
Nodes (52): alertHtml(), alerts(), compute(), explode(), findProduct(), metric(), orderDate(), render() (+44 more)

### Community 2 - "finance-workbench-v31.js"
Cohesion: 0.06
Nodes (46): actual(), barChart(), bind(), cashEditor(), dashboard(), decisions(), empty(), exportJson() (+38 more)

### Community 3 - "approved_for_promotion"
Cohesion: 0.05
...
### Community 34 - "aire-tiempo-committee-v09.js"
Cohesion: 0.24
Nodes (18): agendaHTML(), applyTemplate(), currentProductId(), decorateForm(), gateRow(), guidedIssues(), guideForGate(), init() (+10 more)

### Community 35 - "operational-evidence-v330.js"
Cohesion: 0.25
Nodes (18): activeEvidence(), allEvidence(), bind(), cancelCorrection(), cardsHtml(), factsHtml(), formHtml(), historyHtml() (+10 more)

### Community 36 - "admin-connectivity-v42.js"
Cohesion: 0.26
Nodes (17): adminClient(), applyLock(), assertConnected(), bindActions(), blockStaleMutation(), copyFor(), detail(), ensureBanner() (+9 more)

### Community 37 - "control-executive-v32.js"
Cohesion: 0.20
Nodes (15): actions(), bar(), bind(), compute(), decorate(), explode(), findProduct(), html() (+7 more)

### Community 38 - "host-mode.js"
Cohesion: 0.24
Nodes (16): add(), applySpecialPageAssets(), applyUtilityV4(), curatePublicChrome(), curatePublicNav(), currentPath(), enhance(), ensureBrowserIdentity() (+8 more)

### Community 39 - "internal-shell-v31.js"
Cohesion: 0.24
...
### Community 62 - "admin-legacy-integrity-v424.js"
Cohesion: 0.46
Nodes (7): init(), interceptLegacyStatus(), markStatuses(), patchLegacyCopy(), reconcile(), setMessage(), transition()

### Community 63 - "schema-v15.sql"
Cohesion: 0.39
...
### Community 69 - "preparar_sitio_materializado_v28.py"
Cohesion: 0.67
Nodes (6): asset_ignore(), copy_surface(), main(), patch_html(), Path, verify_surface()

### Community 70 - "connected-internal-orders-v423.spec.js"
Cohesion: 0.29
Nodes (4): fs, path, source, { test, expect }

### Community 71 - "master-cost-bridge-v13.spec.js"
Cohesion: 0.29
Nodes (3): SESSION, STANDARD_EVENT, {test,expect}

### Community 72 - "pilot-daily-v374.spec.js"
Cohesion: 0.33
Nodes (4): attestations, begin(), {test,expect}, today()

### Community 73 - "pilot-intake-v372.spec.js"
Cohesion: 0.33
Nodes (4): fillBaseOrder(), RECEIPT_PNG, {test,expect}, today()

### Community 75 - "finance-starter-v31.js"
Cohesion: 0.60
Nodes (5): create(), enhance(), months24(), publicSkuRows(), starter()

### Community 76 - "product-v30.js"
Cohesion: 0.60
Nodes (5): craftProofHTML(), currentProduct(), enhance(), renderSensory(), sectionHTML()

### Community 77 - "schema-v25.sql"
Cohesion: 0.40
...
### Community 81 - "oferta-v09.spec.js"
Cohesion: 0.40
Nodes (3): openOffer(), seedInternalSession(), { test, expect }

### Community 83 - "schema-v19.sql"
Cohesion: 0.60
...
### Community 85 - "schema-v24.sql"
Cohesion: 0.50
Nodes (3): public.material_purchases, public.material_suppliers, public.production_measurements

### Community 88 - "actas-v09.spec.js"
Cohesion: 0.50
Nodes (3): openActs(), seedInternalSession(), { test, expect }

### Community 93 - "management-pulse-v35.spec.js"
Cohesion: 0.50
Nodes (3): financeDemo(), internalSession(), {test,expect}

### Community 101 - "schema-v23.sql"
Cohesion: 0.83
Nodes (3): public.material_inventory, public.material_master, public.product_bom

### Community 102 - "materializar_fuentes_locales_v28.py"
Cohesion: 0.83
Nodes (3): main(), materialize(), sha256()

### Community 103 - "migrar_runtime_canonico_v08.py"
Cohesion: 0.83
Nodes (3): migrate_workflow(), read(), write()

### Community 112 - "verificar_studio_oferta_v09.py"
Cohesion: 1.00
Nodes (3): main(), require(), text()

### Community 120 - "editorial-v29.spec.js"
Cohesion: 0.50
Nodes (3): forbiddenClosedClaims, { test, expect }, v30Ids

### Community 121 - "finance-usability-v351.spec.js"
Cohesion: 0.67
Nodes (3): openDesk(), seed(), {test,expect}

### Community 129 - "internal-ux-v330.spec.js"
Cohesion: 0.67
Nodes (3): financeDemo(), internalSession(), {test,expect}

### Community 138 - "product-v305.spec.js"
Cohesion: 0.50
Nodes (3): expected, pizzas, { test, expect }

### Community 142 - "v4-checkout.spec.js"
Cohesion: 0.67
Nodes (3): openCheckout(), seedCart(), { test, expect }

## Knowledge Gaps
- **183 isolated node(s):** `version`, `status`, `import_commit`, `integrity`, `source_zip_drive_id` (+178 more)
...
- **Why does `order()` connect `procurement-v25.js` to `operations-v16.js`, `control-executive-v32.js`, `commerce-v14.js`, `business-pulse-v34.js`, `finance-v27.js`, `finance-procurement-v326.js`, `pilot-daily-v374.js`, `production-v22.js`, `daily-ops-v21.js`, `mfo-v30.js`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `compute()` connect `control-executive-v32.js` to `procurement-v25.js`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `actions()` connect `control-executive-v32.js` to `internal-ux-v39.js`?**
...
- **Should `public-config-admin-v42.js` be split into smaller, more focused modules?**
