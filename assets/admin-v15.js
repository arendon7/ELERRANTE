  ...
  function activationPanel(container){
    container.innerHTML = `
      <section class="ee-v14-auth ee-v15-activation">
        <p class="eyebrow">Administración V2.4</p>
        ...
        <div class="ee-v15-checklist"><span>1. Crear o seleccionar el proyecto Supabase.</span><span>2. Ejecutar las migraciones V1.4, V1.5, V1.6, V1.9, V2.0, V2.1, V2.2, V2.3 y V2.4.</span><span>3. Registrar la URL y la publishable key en GitHub Actions.</span><span>4. Crear el usuario de Juan y autorizarlo en <code>admin_users</code>.</span></div>
