...
require('deploy-version.txt','version=2.1.0','El marcador público no declara V2.1')
require('deploy-version.txt','cache=el-errante-v2-1-0','El marcador público no declara caché V2.1')
