(()=>{
  ...
  function healthChecklist(health){
    ...
    return [
      checklistItem(health?.schema_version==='2.0','Esquema V2.0','La función de diagnóstico responde desde Supabase.'),
      checklistItem(['1.4','1.5','1.6','1.9','2.0'].every(value=>migrations.includes(value)),'Migraciones completas',`Registradas: ${migrations.join(', ')||'ninguna'}`),
