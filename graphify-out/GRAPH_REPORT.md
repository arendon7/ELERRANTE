...
## Summary
- 1909 nodes · 3412 edges · 206 communities (139 shown, 67 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dbd0bce9`
...
### Community 1 - "finance-workbench-v31.js"
Cohesion: 0.08
Nodes (40): actual(), barChart(), bind(), cashEditor(), dashboard(), decisions(), empty(), exportJson() (+32 more)

### Community 2 - "admin-config-promotion-v42.js"
Cohesion: 0.10
Nodes (34): authenticate(), createAccount(), derive(), field(), findReviewAccount(), nextTarget(), openSession(), render() (+26 more)
...
### Community 12 - "activation-v20.js"
Cohesion: 0.13
...
### Community 18 - "historical-cost-snapshots-v14.js"
Cohesion: 0.19
...
### Community 80 - "oferta-v09.spec.js"
Cohesion: 0.40
Nodes (3): openOffer(), seedInternalSession(), { test, expect }

### Community 82 - "schema-v19.sql"
Cohesion: 0.60
...
### Community 84 - "schema-v24.sql"
Cohesion: 0.50
Nodes (3): public.material_purchases, public.material_suppliers, public.production_measurements

### Community 87 - "actas-v09.spec.js"
Cohesion: 0.50
Nodes (3): openActs(), seedInternalSession(), { test, expect }

### Community 92 - "management-pulse-v35.spec.js"
Cohesion: 0.50
Nodes (3): financeDemo(), internalSession(), {test,expect}

### Community 100 - "schema-v23.sql"
Cohesion: 0.83
Nodes (3): public.material_inventory, public.material_master, public.product_bom

### Community 101 - "materializar_fuentes_locales_v28.py"
Cohesion: 0.83
Nodes (3): main(), materialize(), sha256()

### Community 102 - "migrar_runtime_canonico_v08.py"
Cohesion: 0.83
Nodes (3): migrate_workflow(), read(), write()

### Community 110 - "verificar_studio_oferta_v09.py"
Cohesion: 1.00
Nodes (3): main(), require(), text()

### Community 118 - "editorial-v29.spec.js"
Cohesion: 0.50
Nodes (3): forbiddenClosedClaims, { test, expect }, v30Ids

### Community 119 - "finance-usability-v351.spec.js"
Cohesion: 0.67
Nodes (3): openDesk(), seed(), {test,expect}

### Community 127 - "internal-ux-v330.spec.js"
Cohesion: 0.67
Nodes (3): financeDemo(), internalSession(), {test,expect}

### Community 136 - "product-v305.spec.js"
Cohesion: 0.50
Nodes (3): expected, pizzas, { test, expect }

### Community 140 - "v4-checkout.spec.js"
Cohesion: 0.67
Nodes (3): openCheckout(), seedCart(), { test, expect }

## Knowledge Gaps
- **172 isolated node(s):** `version`, `status`, `import_commit`, `integrity`, `source_zip_drive_id` (+167 more)
...
- **Why does `order()` connect `procurement-v25.js` to `operations-v16.js`, `control-executive-v32.js`, `business-pulse-v34.js`, `commerce-v14.js`, `finance-v27.js`, `control-v30.js`, `finance-procurement-v326.js`, `pilot-daily-v374.js`, `production-v22.js`, `daily-ops-v21.js`, `mfo-v30.js`?**
...
- **Should `finance-workbench-v31.js` be split into smaller, more focused modules?**
