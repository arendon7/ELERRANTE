...
test.describe('Hardening de gobierno interno V3.1.1',()=>{
  ...
  test('Studio usa el shell interno sin romper el acceso directo histórico',async({page})=>{
  ...
  test('Actas usa el shell interno y conserva el motor histórico de validación',async({page})=>{
