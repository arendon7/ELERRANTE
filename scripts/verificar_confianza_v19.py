...
require("admin.html", "Operación, finanzas y confianza · V1.9", "assets/trust-v19.js", "assets/trust-v19.css")
require("assets/commerce-config-v14.js", 'version: "1.9.0"', "deliveryFeePolicy", "expectedResponseHours")
require("assets/host-mode.js", 'PUBLIC_VERSION="1.9.0"', 'ACTIVE_CACHE="el-errante-v1-9-0"')
require("service-worker.js", "el-errante-v1-9-0", "assets/trust-v19.js", "assets/trust-v19.css", "schema-v19.sql")
