...
for marker in ["Operación, finanzas y activación · V2.0", 'id="operations-v16"', "operations-v16.js", "commerce-v16.css"]:
...
if "el-errante-v2-0-0" not in worker:
    ISSUES.append("Service worker no usa caché V1.6")
if 'PUBLIC_VERSION="2.0.0"' not in host or 'ACTIVE_CACHE="el-errante-v2-0-0"' not in host:
