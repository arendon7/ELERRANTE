...
worker=require(Path('service-worker.js'),"el-errante-v2-4-0",'production-v22.js','production-v22.css','schema-v22.sql')
host=require(Path('assets/host-mode.js'),'PUBLIC_VERSION="2.4.0"','ACTIVE_CACHE="el-errante-v2-4-0"')
version=require(Path('deploy-version.txt'),'version=2.4.0')
